...
var guestArr = ["SCHOOL FRIENDS", "COLLEGE FRIENDS", "UNIVERSITY FRIENDS"];
guestArr.map(function (item) { return (console.log("\"Dear ".concat(item, ", I would like to invite you to dinner. It would be an honor to have you join us.\""))); });
